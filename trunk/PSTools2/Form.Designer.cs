...
namespace PSTools
{
	...
	public partial class Form : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			//Install
			//
			this.Install.Location = new System.Drawing.Point(6, 119);
			this.Install.Name = "Install";
			this.Install.Size = new System.Drawing.Size(247, 23);
			this.Install.TabIndex = 0;
			this.Install.Text = "Button1";
			...
			this.AutoArchive.Location = new System.Drawing.Point(10, 45);
			...
			this.LabelCS55.Location = new System.Drawing.Point(103, 90);
			...
			this.NamedExportQuality.Maximum = new decimal(new int[] {12, 0, 0, 0});
			this.NamedExportQuality.Minimum = new decimal(new int[] {1, 0, 0, 0});
			...
			this.NamedExportQuality.Value = new decimal(new int[] {6, 0, 0, 0});
			//
			//Label2
			//
			...
			this.LabelCompiled.Location = new System.Drawing.Point(13, 374);
			this.LabelCompiled.Name = "LabelCompiled";
			this.LabelCompiled.Size = new System.Drawing.Size(39, 13);
			this.LabelCompiled.TabIndex = 6;
			this.LabelCompiled.Text = "Label4";
			//
			//Form
			//
